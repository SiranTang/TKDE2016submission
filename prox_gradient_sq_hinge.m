function [alpha, w_k, tauk, obj_hist] = prox_gradient_sq_hinge(Data, y, p, sub_feat_ind, B, C, w_k, tau, eps_inner, max_iter, verbose)
% Master problem optimization w.r.t. the sequared hinge loss in the primal form
%
%Input:
...
for iter = 1:max_iter
   ...
   [fv, dw] = calculate_fobj_gw_sq_hinge(Data, y, v, p, B, C, sub_feat_ind);
